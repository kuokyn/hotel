...
public class RoomReservationListController {
    ...
    public String showReservationList(Model model, Pageable pageable, @ModelAttribute("searchCommand") RoomReservationFilter search) {
    ...
    public String showReservationList2(Model model, Pageable pageable, @ModelAttribute("searchCommand") RoomReservationFilter search) {
        model.addAttribute("roomReservationListPage", roomReservationService.getAllRoomReservations(search, pageable));
        return "reservationList";
    }

    @RequestMapping(value = "/yourReservationList.html", method = {RequestMethod.GET})
    public String showYourReservationList(Model model, Pageable pageable, @ModelAttribute("searchCommand") RoomReservationFilter search, Principal principal) {
